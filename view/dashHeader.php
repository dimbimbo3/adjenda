	...
	<header>
		...
		<nav class="navbar navbar-expand-sm navbar-light sticky-top" style="background-color: #0079C2;">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item">
					<a class="nav-link" style="color: white" href=http://localhost/adjenda/dashboard/dash.php>
						Dashboard
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link" style="color: white; padding-left: 1%;" href=http://localhost/adjenda/login/login.php>
						LOGOUT
					</a>
				</li>
			</ul>
